...
vname,img_ext,epsilon_new = "kid-football","jpg",0.05
#vname,img_ext,epsilon_new = "hummingbird","png",0.1
...
# Run BIST
kwargs = {"n":25,"read_video":True,"gamma":4.0,"epsilon_new":epsilon_new,'rgb2lab':True,"nimgs":3,"logging":1,"verbose":True}
